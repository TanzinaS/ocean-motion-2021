...
my_file.write("set filedh =  {$dhdir}/geopotential"+ date +".gr"+ "\n")
my_file.write("set filest =  {$dendir}/density"+ date+".gr"+ "\n")
my_file.write("set filestm = $auxdir}/st0/"+ date+"_st0.dat"+ "\n")
#my_file.write("set filegrv = {$dir}ss1a2grv.gr")
my_file.write("set filequ =  {$outdir}/u/"+ date+"_qu.gr"+ "\n")
my_file.write("set fileqv =  {$outdir}/v/"+ date+"_qv.gr"+ "\n")
my_file.write("set fileqdi = {$auxdir}/qdi/"+ date+"_qdi.gr"+ "\n")
my_file.write("\n")
...
my_file.write("set filestm = {$auxdir}/st0/"+ date +"_st0.dat"+ "\n")
my_file.write("set fileqdi = {$auxdir}/qdi/"+ date +"_qdi.gr"+ "\n")
my_file.write("set filew =   {$outdir}w/"+ date +"_ww.gr"+ "\n")
my_file.write("\n")
